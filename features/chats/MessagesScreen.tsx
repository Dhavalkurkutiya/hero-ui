      ...
      >
        ...
        <View className="mb-12">
          <View className="flex-row items-baseline justify-between mb-6">
            ...
            <Text className="font-bold text-[10px] uppercase tracking-widest text-primary-container">12 Active</Text>
          </View>
          ...
          >
            ...
            >
              ...
              <View className="absolute bottom-0 w-full h-1/2 bg-linear-to-t from-black/80 to-transparent" />
        ...
        <View className="flex-col">
          <View className="flex-row items-center justify-between mb-6">
            ...
            <View className="flex-1 h-px bg-outline-variant/40 ml-4" />
          </View>
